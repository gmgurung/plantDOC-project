    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSwatch(
          primarySwatch: const MaterialColor(0xFF58B76D, {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _convertImageToBytes() async {
    ...
    // You can now use the bytes for further processing (e.g., display debug info)
    print("Image converted to bytes. Byte length: ${bytes.length}");
  }
